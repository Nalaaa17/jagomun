...
<div class="bg-slate-50 min-h-screen">
    <div class="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white shadow-2xl shadow-slate-300/20 rounded-xl p-8">
            ...
            <form id="registration-form" action="{{ route('registration.observerSubmit') }}" method="POST" enctype="multipart/form-data">
                @csrf
...
<style>
    ...
    .stepper-item.active .step-counter { @apply bg-indigo-600 text-white; }
    .stepper-item.completed + .border-t-2 { @apply border-indigo-600; }
