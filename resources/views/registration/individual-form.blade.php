...
<div class="bg-slate-50 min-h-screen">
    <div class="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-10 px-4">
            <div id="stepper" class="flex items-center max-w-2xl mx-auto">
                ...
                <div class="stepper-item">
                    <div class="step-counter"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5"><path stroke-linecap="round" stroke-linejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m2.25 0H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z" /></svg></div>
                </div>
                <div class="flex-auto border-t-2 transition duration-500 ease-in-out border-gray-300"></div>
                <div class="stepper-item">
                    <div class="step-counter"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-5 h-5"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1.5-1.5m1.5 1.5l1.5-1.5m3.75 5.25v-3.75m-3.75 3.75v-3.75m3.75 3.75h3.75m-3.75 0h-3.75m3.75 0v3.75m-3.75-3.75v3.75" /></svg></div>
                </div>
                 <div class="flex-auto border-t-2 transition duration-500 ease-in-out border-gray-300"></div>
                <div class="stepper-item">
        ...
        <div class="bg-white shadow-2xl shadow-slate-300/20 rounded-xl p-8">
            ...
            <form id="registration-form" action="{{ route('registration.individualSubmit') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div id="step-1" class="form-step active-step">
                    <div class="step-content">
                        <h2 class="text-2xl font-semibold text-slate-700 mb-6 border-l-4 border-indigo-500 pl-4">Personal Information</h2>
                ...
                <div id="step-2" class="form-step">
                     <div class="step-content">
                        <h2 class="text-2xl font-semibold text-slate-700 mb-6 border-l-4 border-indigo-500 pl-4">Experience & Documents</h2>
                        <div class="grid grid-cols-1 md:grid-cols-1 gap-6">
                            <div>
                                <x-input-label for="previous_mun_experience" :value="__('Previous MUN Experience (if any)')" />
                                <p class="text-sm text-slate-500 mb-1">Format: MUN Name_Council_Year. Separate with a new line for multiple entries.</p>
                            ...
                            <div>
                                ...
                                <p class="text-sm text-slate-500 mb-1">Format: Award_MUN Name_Year. Separate with a new line for multiple entries.</p>
                ...
                <div id="step-3" class="form-step">
                     <div class="step-content">
                        <h2 class="text-2xl font-semibold text-slate-700 mb-6 border-l-4 border-indigo-500 pl-4">Council and Country Preference</h2>
                     ...
                     <div class="step-content">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    <label class="font-medium text-sm text-gray-700">Social Media Upload <a href="https://www.instagram.com/jagomun.2025" target="_blank" class="text-indigo-600 hover:underline">@jagomun.2025</label>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    Object.keys(packagePrices).forEach((name) => {
        ...
        label.className = "flex justify-between items-center cursor-pointer p-4 border rounded-lg has-[:checked]:bg-indigo-50 has-[:checked]:border-indigo-500 has-[:checked]:ring-2 has-[:checked]:ring-indigo-200 transition-all";
    ...
    async function checkReferralCode() {
        ...
        try {
            ...
            if (response.ok && data.valid) {
                ...
                currentDiscount = 0;
                referralStatusEl.innerHTML = `<span class="font-semibold text-red-600">❌ ${data.message}</span>`;
            }
        } catch (error) {
            currentDiscount = 0;
