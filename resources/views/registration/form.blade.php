...
<div class="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
    <div class="bg-white shadow-xl rounded-lg p-8">
        <div class="text-center mb-8">
            ...
            <h1 class="text-3xl font-bold text-gray-800">I am Registering as Individual</h1>
        </div>
        ...
        <form action="{{ route('registration.submit') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="border border-gray-300 p-6 rounded-lg mb-8 bg-orange-50 bg-opacity-20">
                <h2 class="text-2xl font-semibold text-gray-700 mb-6">Council Preference 1</h2>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <select id="council_preference_1" name="council_preference_1" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">
                            ...
                            <option value="General Assembly" {{ old('council_preference_1') == 'General Assembly' ? 'selected' : '' }}>General Assembly</option>
                            <option value="Security Council" {{ old('council_preference_1') == 'Security Council' ? 'selected' : '' }}>Security Council</option>
                            <option value="ECOSOC" {{ old('council_preference_1') == 'ECOSOC' ? 'selected' : '' }}>ECOSOC</option>
                            {{-- Tambahkan lebih banyak opsi council --}}
                        </select>
                        <x-input-error :messages="$errors->get('council_preference_1')" class="mt-2" />
                    </div>
                    <div>
                        ...
                        <select id="country_preference_1_1" name="country_preference_1_1" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">
                            ...
                            <option value="USA" {{ old('country_preference_1_1') == 'USA' ? 'selected' : '' }}>USA</option>
                            <option value="China" {{ old('country_preference_1_1') == 'China' ? 'selected' : '' }}>China</option>
                            <option value="India" {{ old('country_preference_1_1') == 'India' ? 'selected' : '' }}>India</option>
                            {{-- Tambahkan lebih banyak opsi negara --}}
                        </select>
                        <x-input-error :messages="$errors->get('country_preference_1_1')" class="mt-2" />
                    </div>
                    <div>
                        ...
                        <select id="country_preference_1_2" name="country_preference_1_2" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">
                            <option value="">Select Country</option>
                            <option value="Germany" {{ old('country_preference_1_2') == 'Germany' ? 'selected' : '' }}>Germany</option>
                            <option value="Japan" {{ old('country_preference_1_2') == 'Japan' ? 'selected' : '' }}>Japan</option>
                            <option value="Brazil" {{ old('country_preference_1_2') == 'Brazil' ? 'selected' : '' }}>Brazil</option>
                            {{-- Tambahkan lebih banyak opsi negara --}}
                        </select>
                        <x-input-error :messages="$errors->get('country_preference_1_2')" class="mt-2" />
                    </div>
                    <div class="md:col-span-3">
                        <x-input-label for="reason_for_first_country_preference_1" :value="__('Reason for First Country Preference')" />
                        <textarea id="reason_for_first_country_preference_1" name="reason_for_first_country_preference_1" rows="3" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">{{ old('reason_for_first_country_preference_1') }}</textarea>
                        <x-input-error :messages="$errors->get('reason_for_first_country_preference_1')" class="mt-2" />
                    </div>
                    <div class="md:col-span-3">
                        <x-input-label for="reason_for_second_country_preference_1" :value="__('Reason for Second Country Preference')" />
                        <textarea id="reason_for_second_country_preference_1" name="reason_for_second_country_preference_1" rows="3" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">{{ old('reason_for_second_country_preference_1') }}</textarea>
                        <x-input-error :messages="$errors->get('reason_for_second_country_preference_1')" class="mt-2" />
                    </div>
                </div>
            </div>
            ...
            <div class="border border-gray-300 p-6 rounded-lg mb-8 bg-orange-50 bg-opacity-20">
                <h2 class="text-2xl font-semibold text-gray-700 mb-6">Council Preference 2</h2>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <select id="council_preference_2" name="council_preference_2" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">
                            <option value="">Select Council</option>
                            <option value="General Assembly" {{ old('council_preference_2') == 'General Assembly' ? 'selected' : '' }}>General Assembly</option>
                            <option value="Security Council" {{ old('council_preference_2') == 'Security Council' ? 'selected' : '' }}>Security Council</option>
                            <option value="ECOSOC" {{ old('council_preference_2') == 'ECOSOC' ? 'selected' : '' }}>ECOSOC</option>
                        </select>
                        <x-input-error :messages="$errors->get('council_preference_2')" class="mt-2" />
                    </div>
                    <div>
                        ...
                        <select id="country_preference_2_1" name="country_preference_2_1" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">
                            <option value="">Select Country</option>
                            <option value="USA" {{ old('country_preference_2_1') == 'USA' ? 'selected' : '' }}>USA</option>
                            <option value="China" {{ old('country_preference_2_1') == 'China' ? 'selected' : '' }}>China</option>
                            <option value="India" {{ old('country_preference_2_1') == 'India' ? 'selected' : '' }}>India</option>
                        </select>
                        <x-input-error :messages="$errors->get('country_preference_2_1')" class="mt-2" />
                    </div>
                    <div>
                        ...
                        <select id="country_preference_2_2" name="country_preference_2_2" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">
                            <option value="">Select Country</option>
                            <option value="Germany" {{ old('country_preference_2_2') == 'Germany' ? 'selected' : '' }}>Germany</option>
                            <option value="Japan" {{ old('country_preference_2_2') == 'Japan' ? 'selected' : '' }}>Japan</option>
                            <option value="Brazil" {{ old('country_preference_2_2') == 'Brazil' ? 'selected' : '' }}>Brazil</option>
                        </select>
                        <x-input-error :messages="$errors->get('country_preference_2_2')" class="mt-2" />
                    </div>
                    <div class="md:col-span-3">
                        <x-input-label for="reason_for_first_country_preference_2" :value="__('Reason for First Country Preference')" />
                        <textarea id="reason_for_first_country_preference_2" name="reason_for_first_country_preference_2" rows="3" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">{{ old('reason_for_first_country_preference_2') }}</textarea>
                        <x-input-error :messages="$errors->get('reason_for_first_country_preference_2')" class="mt-2" />
                    </div>
                    <div class="md:col-span-3">
                        <x-input-label for="reason_for_second_country_preference_2" :value="__('Reason for Second Country Preference')" />
                        <textarea id="reason_for_second_country_preference_2" name="reason_for_second_country_preference_2" rows="3" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">{{ old('reason_for_second_country_preference_2') }}</textarea>
                        <x-input-error :messages="$errors->get('reason_for_second_country_preference_2')" class="mt-2" />
                    </div>
                </div>
            </div>
            ...
            <div class="border border-gray-300 p-6 rounded-lg mb-8 bg-orange-50 bg-opacity-20">
                <h2 class="text-2xl font-semibold text-gray-700 mb-6">Council Preference 3</h2>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <select id="council_preference_3" name="council_preference_3" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">
                            <option value="">Select Council</option>
                            <option value="General Assembly" {{ old('council_preference_3') == 'General Assembly' ? 'selected' : '' }}>General Assembly</option>
                            <option value="Security Council" {{ old('council_preference_3') == 'Security Council' ? 'selected' : '' }}>Security Council</option>
                            <option value="ECOSOC" {{ old('council_preference_3') == 'ECOSOC' ? 'selected' : '' }}>ECOSOC</option>
                        </select>
                        <x-input-error :messages="$errors->get('council_preference_3')" class="mt-2" />
                    </div>
                    <div>
                        ...
                        <select id="country_preference_3_1" name="country_preference_3_1" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">
                            <option value="">Select Country</option>
                            <option value="USA" {{ old('country_preference_3_1') == 'USA' ? 'selected' : '' }}>USA</option>
                            <option value="China" {{ old('country_preference_3_1') == 'China' ? 'selected' : '' }}>China</option>
                            <option value="India" {{ old('country_preference_3_1') == 'India' ? 'selected' : '' }}>India</option>
                        </select>
                        <x-input-error :messages="$errors->get('country_preference_3_1')" class="mt-2" />
                    </div>
                    <div>
                        ...
                        <select id="country_preference_3_2" name="country_preference_3_2" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">
                            <option value="">Select Country</option>
                            <option value="Germany" {{ old('country_preference_3_2') == 'Germany' ? 'selected' : '' }}>Germany</option>
                            <option value="Japan" {{ old('country_preference_3_2') == 'Japan' ? 'selected' : '' }}>Japan</option>
                            <option value="Brazil" {{ old('country_preference_3_2') == 'Brazil' ? 'selected' : '' }}>Brazil</option>
                        </select>
                        <x-input-error :messages="$errors->get('country_preference_3_2')" class="mt-2" />
                    </div>
                    <div class="md:col-span-3">
                        <x-input-label for="reason_for_first_country_preference_3" :value="__('Reason for First Country Preference')" />
                        <textarea id="reason_for_first_country_preference_3" name="reason_for_first_country_preference_3" rows="3" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">{{ old('reason_for_first_country_preference_3') }}</textarea>
                        <x-input-error :messages="$errors->get('reason_for_first_country_preference_3')" class="mt-2" />
                    </div>
                    <div class="md:col-span-3">
                        <x-input-label for="reason_for_second_country_preference_3" :value="__('Reason for Second Country Preference')" />
                        <textarea id="reason_for_second_country_preference_3" name="reason_for_second_country_preference_3" rows="3" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm block mt-1 w-full">{{ old('reason_for_second_country_preference_3') }}</textarea>
                        <x-input-error :messages="$errors->get('reason_for_second_country_preference_3')" class="mt-2" />
                    </div>
                </div>
            </div>
            ...
            <div class="border border-gray-300 p-6 rounded-lg mb-8 bg-orange-50 bg-opacity-20">
                ...
                <div class="mb-6">
                    ...
                    <label for="payment_proof" class="flex items-center justify-center border-2 border-dashed border-gray-400 rounded-lg p-6 cursor-pointer hover:border-blue-500 hover:bg-gray-50 transition duration-150 ease-in-out">
                        <div class="text-center">
                            ...
                            <p class="mt-1 text-sm text-gray-600">Please upload your file. Max size 2 MB.</p>
                ...
                <div class="mb-6">
                    ...
                    <a href="#" class="text-blue-600 hover:underline">Click to see the petition template</a>)
...
<script>
    // Script untuk menampilkan nama file yang diupload (opsional, untuk UX)
    document.addEventListener('DOMContentLoaded', function() {
        const paymentInput = document.getElementById('payment_proof');
        if (paymentInput) {
            paymentInput.addEventListener('change', function() {
                const label = this.closest('label').querySelector('p:first-of-type');
                if (this.files && this.files.length > 0) {
                    label.textContent = this.files[0].name;
                } else {
                    label.textContent = 'Please upload your file. Max size 2 MB.';
                }
            });
        }
