...
<head>
    ...
    <style>
        ...
        #deck-container {
            perspective: 1500px;
            /* Tambahkan perspektif untuk efek 3D yang lebih baik */
            position: relative;
        }
        ...
        @keyframes toss-away {
            ...
            30% {
                transform: translate3d(20%, -10%, 0) rotate(5deg) scale(1.05);
            }

            /* Angkat sedikit */
            100% {
                transform: translate3d(150%, 20%, -200px) rotate(35deg) scale(0.5);
                opacity: 0;
            }
        ...
        @keyframes return-from-side {
            0% {
                transform: translate3d(-150%, 0, -200px) rotate(-35deg) scale(0.7);
                opacity: 0;
            }
        ...
        .is-returning {
            ...
            z-index: 4 !important;
            /* Pastikan ia terbang di atas segalanya */
        }
        ...
        .council-menu-item {
            ...
            flex-shrink: 0;
            width: 180px;
            /* Lebar setiap item di barisan mobile */
        ...
        .council-menu-item.active {
            ...
            background-color: rgba(180, 151, 107, 0.2);
            /* bg-gold/20 */
        ...
        .council-detail-content {
            ...
            background-color: rgba(45, 59, 97, 0.3);
            /* bg-royal/30 */
            border-radius: 1rem;
        ...
        @media (min-width: 768px) {
            .council-detail-content {
                ...
                inset: 0;
                display: block;
                /* Tampilkan semua di DOM untuk transisi */
                padding: 2rem;
                background-color: transparent;
                /* Latar belakang diatur oleh parent di desktop */
                border-radius: 0;
        ...
        .section-separator::after {
            ...
            background: linear-gradient(to right,
                    transparent,
                    rgba(180, 151, 107, 0.35),
                    /* Opacity sedikit dinaikkan agar lebih jelas */
                    transparent);
...
<body class="bg-ivory text-royal">
    <nav class="fixed w-full z-50 transition-all duration-300" id="navbar">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-8">
                ...
                <div class="hidden lg:flex items-center space-x-8">
                    ...
                    <a href="{{ route('about') }}"
                        class="text-white hover:text-gold transition-colors duration-300">About</a>
                    <a href="{{ route('councils') }}"
                        class="text-white hover:text-gold transition-colors duration-300">Councils</a>
                    <a href="{{ route('contact.index') }}"
                        class="text-white hover:text-gold transition-colors duration-300">FAQ</a>
        ...
        <div id="mobile-menu" class="lg:hidden hidden bg-navy/95 backdrop-blur-lg">
            <div class="px-2 pt-2 pb-3 space-y-1">
                ...
                <a href="{{ route('councils') }}"
                    class="mobile-link block px-3 py-2 text-white hover:text-gold">Councils</a>
                <a href="{{ route('contact.index') }}"
    ...
    <section id="home" class="relative min-h-screen overflow-hidden">
        <div class="absolute inset-0 z-0">
            ...
            <div class="absolute inset-0"
                style="background: linear-gradient(135deg, rgba(30, 34, 51, 0.85) 0%, rgba(45, 59, 97, 0.85) 100%);">
            </div>
        </div>
        <div class="relative z-10 max-w-7xl mx-auto px-4 py-24 lg:py-32 flex flex-col justify-center min-h-screen">
            <div class="text-center animate-fadeInUp">
                ...
                <p
                    class="text-xl md:text-2xl text-white/80 mb-12 max-w-4xl mx-auto leading-relaxed animate-slideInRight">
                    An international forum for young leaders to engage in diplomatic discourse, develop critical
            ...
            <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                    stroke="currentColor" class="w-8 h-8 text-white/70">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m19.5 8.25-7.5 7.5-7.5-7.5" />
                </svg>
            </div>
    </section>

    <section id="news" class="py-24 bg-navy relative overflow-hidden parallax-section"
        style="--bg-image: url('/images/raja.jpg');">
        <div class="absolute inset-0 backdrop-blur-sm z-[-1]"
            style="background: linear-gradient(135deg, rgba(30, 34, 51, 0.85) 0%, rgba(45, 59, 97, 0.85) 100%);"></div>
                        ...
                        <div class="relative text-center">
                            ...
                            <div class="bg-royal/50 backdrop-blur-lg rounded-xl border border-gold/20 shadow-2xl shadow-black/20 overflow-hidden card-hover"
                                ...
                                <div class="p-6">
                                    ...
                                    <p class="text-white/80 text-sm text-justify">Exciting news! We'll be offering
                                        early bird cashback for the first 5 delegates who register got cashback 5%!!</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="relative text-center">
                            ...
                            <div class="bg-royal/50 backdrop-blur-lg rounded-xl border border-gold/20 shadow-2xl shadow-black/20 overflow-hidden card-hover"
                                ...
                                <div class="p-6">
                                    ...
                                    <p class="text-white/80 text-sm text-justify">Curious about the topics? The
                                        detailed information for all councils and their topics can be found in the
                                        “Council” menu.</p>
                                </div>
                            </div>
                        </div>
    ...
    <section id="about" class="py-24 bg-navy relative overflow-hidden parallax-section"
        style="--bg-image: url('/images/raja.jpg');">
        <div class="absolute inset-0 backdrop-blur-sm z-[-1]"
            style="background: linear-gradient(135deg, rgba(30, 34, 51, 0.85) 0%, rgba(45, 59, 97, 0.85) 100%);"></div>
        ...
        <div class="max-w-7xl mx-auto px-4 relative z-10">
            <div class="text-center mb-16 scroll-reveal">
                <h2 class="text-4xl md:text-5xl font-bold text-white mb-6">Words of Remark from <br
                        class="sm:hidden" /> <span class="gradient-text">Secretary General</span></h2>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-12 items-center">
                ...
                <div class="lg:col-span-2 flex justify-center scroll-reveal" data-reveal="left">
                    <div class="relative group">
                        <div
                            class="absolute -inset-3 bg-gradient-to-br from-gold to-champagne rounded-full transform-gpu transition-all duration-700 group-hover:rotate-12 group-hover:scale-105">
                        </div>
                        <div
                            class="absolute -inset-3 rounded-full bg-[url('/images/awan.jpeg')] bg-repeat opacity-10 z-0">
                        </div>
                        <img src="{{ asset('images/sg.png') }}"
                            class="relative rounded-full shadow-2xl w-64 h-64 md:w-80 md:h-80 mx-auto object-cover border-4 border-navy z-10"
                ...
                <div class="lg:col-span-3 scroll-reveal" data-reveal="right">
                    <div
                        class="bg-royal/50 backdrop-blur-xl rounded-2xl p-8 lg:p-10 border border-gold/20 shadow-2xl shadow-black/30 relative">
                        ...
                        <div class="text-white/90 space-y-4 leading-relaxed">
                            <p class="font-semibold italic text-justify">
                                "It is with great pride and heartfelt enthusiasm to introducing Jember Annual Global
                                Model United Nations (JAGOMUN) 2025.

                                This year’s theme, Bridging the Gap: Reimagining World Prosperity and Development Amid
                                Shifting Global Forces,” calls upon us all to reflect, question, and act. We live in a
                                time where global forces — from geopolitical tension — continue to reshape our shared
                                future. In the face of uncertainty, the world needs bold, empathetic, and
                                forward-thinking leaders more than ever.
                            ...
                            <p class="pt-4 border-t border-gold/20 text-justify">
                                At JAGOMUN, we believe that young people are not just future leaders — you are today’s
                                changemakers. Your ideas, your passion, and your voice have the power to influence
                                discourse, bridge global divides, and reimagine development that is inclusive and
                                sustainable.

                                JAGOMUN is more than a simulation; it is a living, breathing space for youth to sharpen
                                their diplomacy, build cross-cultural understanding, and take responsibility as global
                                citizens.

                            </p>
                            <p class="text-justify">
                                This conference is your platform to grow, challenge perspectives, and become catalysts
                                for real-world change. Whether you are speaking in committee sessions, drafting
                                resolutions, or engaging in cultural exchange — your role here matters.

                                Welcome to JAGOMUN 2025 — where youth lead the conversation, diplomacy drives action,
                                and the future begins with you
    ...
    <section id="experience" class="py-24 bg-navy relative overflow-hidden parallax-section"
        style="--bg-image: url('/images/raja.jpg');">
        <div class="absolute inset-0 backdrop-blur-sm z-[-1]"
            style="background: linear-gradient(135deg, rgba(30, 34, 51, 0.85) 0%, rgba(45, 59, 97, 0.85) 100%);"></div>
        ...
        <div class="max-w-7xl mx-auto px-4 relative z-10">
            <div class="text-center mb-16 scroll-reveal">
                <h2 class="text-4xl md:text-5xl font-bold text-white mb-6">Previously on <span
                        class="gradient-text">JAGOMUN 2024</span></h2>
                <p class="text-xl text-white/90 max-w-4xl mx-auto">
                    JAGOMUN 2024 was a great success, attracting 100+ delegates from 9 countries and receiving support
                    from many distinguished institutions.
                </p>
            </div>
            ...
            <div class="flex justify-center items-center gap-6 mt-8">
                <button id="prevBtnDeck"
                    class="group w-16 h-16 bg-white/50 hover:bg-white border border-royal/20 rounded-full flex items-center justify-center transition-all duration-300 shadow-lg hover:scale-105">
                    <i
                        class="fas fa-arrow-left text-2xl text-royal transition-transform group-hover:-translate-x-1"></i>
                </button>
                <button id="nextBtnDeck"
                    class="group w-16 h-16 bg-white/50 hover:bg-white border border-royal/20 rounded-full flex items-center justify-center transition-all duration-300 shadow-lg hover:scale-105">
                    <i
                        class="fas fa-arrow-right text-2xl text-royal transition-transform group-hover:translate-x-1"></i>
                </button>
            </div>
        </div>
    </section>

    <section id="councils" class="py-24 bg-navy relative overflow-hidden parallax-section"
        style="--bg-image: url('/images/raja.jpg');">
        <div class="absolute inset-0 backdrop-blur-sm z-[-1]"
            style="background: linear-gradient(135deg, rgba(30, 34, 51, 0.85) 0%, rgba(45, 59, 97, 0.85) 100%);"></div>
        ...
        <div class="max-w-7xl mx-auto px-4 relative z-10">
            <div class="text-center mb-12 scroll-reveal">
                <h2 class="text-4xl md:text-5xl font-bold text-white mb-6">Available <span
                        class="gradient-text">Councils</span></h2>
                <p class="text-xl text-white/90 max-w-3xl mx-auto">Choose a committee to see the details and represent
                    your assigned country.</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-12 gap-8 md:min-h-[550px]">

                <div class="md:col-span-4">
                    <div id="council-menu-container"
                        class="relative md:bg-royal/30 p-2 md:rounded-2xl flex md:block overflow-x-auto md:overflow-visible space-x-2 md:space-x-0 md:space-y-2 no-scrollbar">
                        <div id="menu-selector"
                            class="hidden md:block absolute bg-gold/20 border border-gold rounded-xl z-0"></div>
                    </div>
                </div>

                <div class="md:col-span-8 mt-4 md:mt-0">
                    <div id="council-display-panel"
                        class="relative w-full md:h-full bg-royal/30 md:backdrop-blur-xl md:rounded-2xl md:border md:border-gold/20 md:shadow-2xl">
                    </div>
                </div>
    ...
    <section id="testimonials" class="py-24 bg-navy relative overflow-hidden parallax-section"
        style="--bg-image: url('/images/raja.jpg');">
        <div class="absolute inset-0 backdrop-blur-sm z-[-1]"
            style="background: linear-gradient(135deg, rgba(30, 34, 51, 0.85) 0%, rgba(45, 59, 97, 0.85) 100%);"></div>
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
                <div class="flex flex-col items-center text-center">
                    <blockquote class="text-lg text-ivory/90 leading-relaxed italic">
                        <p class="text-justify">"It was an opportunity to attend JAGOMUN 2024 as a delegate. One of the
                            aspects that i really liked from jagomun2024 was the hard working hospitality crews, not
                            only did we get to experience what a proper MUN is like but their to interact with the
                            staffs especially them was a great experience itself!, at first i was already stunned and
                            nervous by the new environment of Jember, but the welcoming greets from the hospitality
                            crews really makes me feels welcomed there, not to mention that (IIRC) 2 nights after we
                            arrived in the hotel, hospitality crews took me and my friends to roam the city and have
                            fun, the event itself was really great!, its not exactly the usual MUN where i felt so
                            pressured, something about the chair/co-chair and the room itself makes me feel so calm and
                            respected, jagomun2024 was the best thing a MUN beginners can learn from and it was very
                            memorable to me since i learned a lot and learned things outside the MUN experience itself,
                            it was definitely definitely worth it."</p>
                    </blockquote>
                    <div class="mt-8 flex flex-col items-center">
                        <img class="h-40 w-40 rounded-full object-cover border-2 border-gold"
                            src="{{ asset('images/muh.jpg') }}">
                        <div class="mt-4">
                ...
                <div class="flex flex-col items-center text-center">
                    <blockquote class="text-lg text-ivory/90 leading-relaxed italic">
                        <p class="text-justify">"Based on my experience at JAGOMUN 2024, I was genuinely impressed by
                            the entire committee, especially the Delegate Relations division. They made sure every
                            aspect of the delegates' needs was well taken care of. I was one of the accommodation
                            delegates, and from the moment they picked me up, they were incredibly helpful and
                            welcoming. They even accompanied me to a souvenir shop to buy some traditional snacks from
                            Jember, and brought me to explore the night market. What impressed me the most was they
                            didn’t just support us as committee members, but also treated us like friends.
                            Everything else like meals, hotel arrangements, and the whole event was excellent as well.
                            Perhaps one small suggestion for this year is it might be even more helpful if delegates
                            could be accompanied to the station, especially for those unfamiliar with the city. A little
                            extra support like that would make the experience feel even more comfortable.
                            So, if you’re considering getting the accommodation package, I highly recommend it. Go for
                            it, and don’t hesitate! :))
                            "</p>
                    </blockquote>
                    <div class="mt-8 flex flex-col items-center">
                        <img class="h-40 w-40 rounded-full object-cover border-2 border-gold"
                            src="{{ asset('images/depi.jpg') }}">
                        <div class="mt-4">
    ...
    <section id="faq" class="py-24 bg-navy relative overflow-hidden parallax-section section-separator"
        style="--bg-image: url('/images/raja.jpg');">
        <div class="absolute inset-0 backdrop-blur-sm z-[-1]"
            style="background: linear-gradient(135deg, rgba(30, 34, 51, 0.85) 0%, rgba(45, 59, 97, 0.85) 100%);"></div>
        ...
        <div class="max-w-4xl mx-auto px-4 relative z-10">
            <div class="text-center mb-16 scroll-reveal">
                <h2 class="text-4xl md:text-5xl font-bold text-white mb-6">Frequently Asked <span
            ...
            <div class="space-y-4 scroll-reveal">
                <div class="faq-item bg-royal/40 backdrop-blur-lg p-6 rounded-xl border border-gold/20">
                    <button class="faq-question w-full text-left flex justify-between items-center">
                        ...
                        <svg class="w-6 h-6 transform transition-transform text-gold" fill="none"
                    ...
                    <div class="faq-answer hidden mt-4 text-white/80 leading-relaxed">
                        <p class="text-justify">JAGOMUN is open to all university students and high school students
                            aged 15-25.</p>
                    </div>
                </div>
                ...
                <div class="faq-item bg-royal/40 backdrop-blur-lg p-6 rounded-xl border border-gold/20">
                    ...
                    <div class="faq-answer hidden mt-4 text-white/80 leading-relaxed">
                        <p class="text-justify">The facilities provided will depend on the package delegate choose. If
                            delegate register with the Accommodation Package, we will provide lodging and local
                            transportation during your stay in Jember, along with meals and full access to all
                            conference sessions. For those who choose the
                            Non-Accommodation Package we provide meals and full access to the conference, but
                            accommodation and local transport are not included. Meanwhile, participants who register
                            under the Online Packagewill receive full access to all conference sessions, materials, and
                            activities virtually through our online platform.
                        </p>
                    </div>
                </div>
                ...
                <div class="faq-item bg-royal/40 backdrop-blur-lg p-6 rounded-xl border border-gold/20">
                    ...
                    <div class="faq-answer hidden mt-4 text-white/80 leading-relaxed">
                        <p class="text-justify">The event will commence with an Opening Ceremony, featuring a talk show
                            with distinguished speakers who are experts in their respective fields, accompanied by
                            welcoming remarks delivered by prominent figures. The core of the event will be the
                            Committee Sessions, where delegates will engage in structured debates, negotiations, and
                            resolution drafting—simulating real diplomatic discussions. To encourage engagement and
                            build meaningful connections among participants, the agenda will also include Social Nights
                            and gala dinner, offering a space for informal interaction and camaraderie. The program will
                            conclude with a Closing Ceremony and Awarding Session, which will be thoughtfully arranged
                            and enhanced with entertainment segments to provide a memorable conclusion to the entire
                            experience.</p>
                    </div>
                </div>
                ...
                <div class="faq-item bg-royal/40 backdrop-blur-lg p-6 rounded-xl border border-gold/20">
                    ...
                    <div class="faq-answer hidden mt-4 text-white/80 leading-relaxed">
                        <p class="text-justify">Absolutely! JAGOMUN is open to delegates of all experience levels. We
                            highly recommend beginner councils like UNEP or UNHCR for first-timers. Additionally, we
                            will provide training materials and a workshop session to help you understand the Rules of
                            Procedure and basic MUN concepts.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="register" class="py-20" style="background: linear-gradient(135deg, #2D3B61 0%, #1E2233 100%);">
        <div class="max-w-4xl mx-auto px-4 text-center scroll-reveal">
            <h2 class="text-4xl md:text-5xl font-bold text-white mb-6">Are You Ready to Speak, Lead, and Embrace your
                Diplomacy?</h2>
            <p class="text-xl text-champagne mb-12 text-justify">
                JAGOMUN 2025 registration is now open! Don’t miss your chance to be part of the most anticipated and
                origin Model United Nations conference in East Java. Secure your seat at the table today!
            </p>
            <a href="#"
                class="group relative inline-flex items-center justify-center px-10 py-4 text-xl font-semibold text-navy bg-gradient-to-r from-gold to-champagne rounded-full hover:shadow-2xl transition-all duration-300 transform hover:scale-105">
                Register Now
            </a>
        </div>
    </section>
        ...
        document.addEventListener('DOMContentLoaded', () => {
                ...
                question?.addEventListener('click', () => {
                    ...
                    faqItems.forEach(otherItem => {
                        if (otherItem !== item) {
                            ...
                            otherItem.querySelector('.faq-question svg')?.classList.remove(
                                'rotate-180');
                        }
                    });
            ...
            const councilData = {
                unep: {
                    ...
                    topics: [
                        'Bridging the Green Divide: Ensuring Equitable Access and Just Transitions In the Global Green Economy'
                    ],
                },
                unhcr: {
                    title: 'The United Nations Human Rights Council ',
                    short_title: 'UNHRC',
                ...
                nato: {
                    ...
                    topics: [
                        'Ambiguity and Assurance: Navigating Eastern Security Commitments within the Alliance'
                    ],
                },
            };
            ...
            `;
                ...
                menuContainer.addEventListener('click', (e) => {
                    ...
                    menuContainer.querySelectorAll('.council-menu-item').forEach(item => item.classList
                        .remove('active'));
                    displayPanel.querySelectorAll('.council-detail-content').forEach(content => content
