    ...
    <form wire:submit.prevent="submitForm" enctype="multipart/form-data"> {{-- Tambahkan enctype untuk upload file --}}
        ...
        <div class="border border-gray-300 p-6 rounded-lg mb-8 bg-orange-50 bg-opacity-20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <x-input-label :value="__('Do you need accommodation?')" />
                    <div class="mt-2 space-x-4">
                        <label class="inline-flex items-center">
                            <input type="radio" wire:model.live="do_you_need_accommodation" value="1" class="form-radio text-blue-600" required>
                            <span class="ml-2 text-gray-700">Yes</span>
                        </label>
                        <label class="inline-flex items-center">
                            <input type="radio" wire:model.live="do_you_need_accommodation" value="0" class="form-radio text-red-600" required>
            ...
            <div class="border border-gray-300 p-6 rounded-lg mb-6 bg-orange-50 bg-opacity-20">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        {{-- wire:ignore for file input to prevent Livewire from resetting it on re-render --}}
                        <div wire>
        ...
        <div class="border border-gray-300 p-6 rounded-lg mb-8 bg-orange-50 bg-opacity-20">
            ...
            <div class="mb-6" wire:ignore> {{-- wire:ignore to prevent Livewire from re-rendering and resetting file input --}}
                ...
                <label for="payment_proof" class="flex items-center justify-center border-2 border-dashed border-gray-400 rounded-lg p-6 cursor-pointer hover:border-blue-500 hover:bg-gray-50 transition duration-150 ease-in-out">
                    <div class="text-center">
                        ...
                        <p class="mt-1 text-sm text-gray-600" id="payment_proof_filename_overall">Please upload your file. Max size 2 MB.</p>
                        <p class="text-xs text-gray-500">Upload your Payment Proof</p>
                    </div>
                    {{-- wire:model untuk upload file --}}
                    <input id="payment_proof" name="payment_proof" type="file" class="hidden" wire:model="payment_proof" accept=".jpg,.jpeg,.png,.pdf" />
                </label>
